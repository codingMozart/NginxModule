...
{
	static ngx_str_t backendQueryLine = ngx_string("GET /s?w=%V HTTP/1.1\r\nHost: www.baidu.com\r\nConnection: close\r\n\r\n");
...
mytest_upstream_process_header(ngx_http_request_t *r)
{
	...
	for(;;){
		...
		ngx_log_error(NGX_LOG_ERR,r ->connection ->log,0,"upstream sent nvalid header");
